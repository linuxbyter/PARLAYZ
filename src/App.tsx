...
import { LogOut, X, AlertTriangle, Bell, Wallet, ArrowDownToLine, ArrowUpFromLine, CheckCircle2, History, Trophy, Activity, Eye, EyeOff, PieChart, Share2, Swords, MessageSquare, Send, ChevronLeft, HelpCircle, Search } from 'lucide-react'
...
              {['All', 'Player Props', 'Sports', 'Crypto', 'Movies', 'Fashion', 'Culture', 'Finance', 'Politics'].map((cat) => (
                <button
                  key={cat}
